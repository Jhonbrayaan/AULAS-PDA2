...
const pegandoUsuariosController = require("../controllers/usuario/pegandoUsuariosController");

const usuarioRoute = express.Router();

usuarioRoute.post("/usuario",criandoUsuarioController);

usuarioRoute.get("/usuario", pegandoUsuariosController);
  
usuarioRoute.put("/usuario/:id", async (req,res)=>{
...
usuarioRoute.delete("/usuario/:id", async (req,res)=>{
    let usuario = require('../models/usuario');
    const id = req.params.id;
